...
# JMH-Disabled this because it also disables Outlook Meeting reminder notifications and all others
...
# Screenshots save format: PNG format (other options: BMP, GIF, JPG, PDF, TIFF)
...
# NOTE: This is a DVD/CD R/W drive, don't have it so don't need to enable this option
...
printf "[INSTALLER] State: Mail Settings\n"
...
# TODO: Add in spellcheck substitutions
# TODO: e.g. if i type "ot he" change this to "on the"
...
# Complete themese bundle: https://github.com/mbadolato/iTerm2-Color-Schemes/zipball/master
open "${HOME}/init/schemes/Solarized Dark.itermcolors"
...
# Disable the all too sensitive backswipe on trackpads - JMH-changed
defaults write com.google.Chrome AppleEnableSwipeNavigateWithScrolls -bool true
defaults write com.google.Chrome.canary AppleEnableSwipeNavigateWithScrolls -bool true

# Disable the all too sensitive backswipe on Magic Mouse - JMH-changed
...
# ===============[ MS Office: Lync ]===============
# Disable continuous spell checking
defaults write com.microsoft.Lync WebContinuousSpellCheckingEnabled -bool false

# Expand save dialog by default
defaults write com.microsoft.Lync NSNavPanelExpandedStateForSaveMode -bool true



# ==============[ MS Office: Outlook ]=================
# Default Font is 12
defaults read com.microsoft.Outlook HTMLWebPrefsIdentifierWebKitDefaultFontSize
defaults write com.microsoft.Outlook HTMLWebPrefsIdentifierWebKitDefaultFontSize -int 12
defaults write com.microsoft.Outlook PlainTextWebPrefsIdentifierWebKitDefaultFontSize -int 12

# Default Font
defaults write com.microsoft.Outlook HTMLWebPrefsIdentifierWebKitStandardFont -string "Calibri"
defaults write com.microsoft.Outlook PlainTextWebPrefsIdentifierWebKitStandardFont -string "Consolas"

# Enable/Disable continuous spell checking
defaults write com.microsoft.Outlook WebContinuousSpellCheckingEnabled -bool false

# Expand save dialog by default
defaults write com.microsoft.Outlook NSNavPanelExpandedStateForSaveMode -bool true




# =============[ locate database ]===========
# DB Path: /var/db/locate.database
...
###############################################################################
echo "OS X Setup Script complete. Killing applications to refresh in 5 seconds..."
sleep 5s
